...
/**
 * @category   Glossary
 * @package    Glossary_Form_Glossary
 * @copyright  Copyright (C) 2005-2010  Preceptor Educação a Distância Ltda. <http://www.preceptoead.com.br>
 * @license    http://www.gnu.org/licenses/  GNU GPL
 */
class Glossary_Form_Glossary extends Zend_Form
{
    /**
     * (non-PHPdoc)
     * @see Zend_Form#init()
    ...
    public function init()
    {
        ...
        $this->setAction('glossary/index/save')
             ->setMethod('post');
        ...
        $word->setLabel('Word')
             ->addValidators($validators['word'])
             ->addFilters($filters['word']);
